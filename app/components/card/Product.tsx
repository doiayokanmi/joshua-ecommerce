      ...
      >
        ...
        <div className="basis-1/2 flex flex-col justify-between flex-1">
          ...
          <div className="flex space-x-1">
            <button className="rounded flex-1 p-2 text-xs capitalize flex items-center bg-black hover:bg-primary text-white">
              <ShoppingBasket className="mr-1 hidden lg:block" size={14} />
              Add to cart
            </button>
            <button className="rounded scale-0 group-hover:scale-100 transition-all duration-300 p-2 capitalize bg-black hover:bg-primary text-white">
